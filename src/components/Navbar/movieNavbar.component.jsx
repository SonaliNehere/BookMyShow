        ...
        <div className="container mx-auto px-4 items-center flex justify-between">
            <div className="flex items-center w-1/2 gap-3">
              ...
              className="w-full h-full"
                ...
                <div className="w-full flex items-center gap-3 bg-white px-3 py-2 mx-3 my-2 rounded-md">
                    <BiSearch />
                    <input
                    type="search"
            ...
            <div className="flex items-center gap-3 ">
                ...
                <button className="bg-red-600 text-white px-2 py-1 text-sm rounded w-25">
                    Sign in
                </button>
...
const MovieNavbar = () => {
    return(
        ...
        <nav className="absolute inset-x-0 z-30 bg-opacity-10 backdrop-filter 
            backdrop-blur-lg lg:relative lg:bg-bms-700 p-4">
